...
export const normalizeRecordingHistoryItem = (
  ...
  return {
    ...
    contextScreenshotPath: item.contextScreenshotPath,
    contextCapturedAt: item.contextCapturedAt,
    contextScreenText: item.contextScreenText,
    contextScreenAppName: item.contextScreenAppName,
    contextScreenWindowTitle: item.contextScreenWindowTitle,
  }
}
