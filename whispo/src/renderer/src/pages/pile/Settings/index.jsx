                          ...
                          <div className={styles.ExpandableContent}>
                            ...
                            >
                              ...
                              <select
                                ...
                                value={
                                  whispoConfigQuery.data.shortcut || "hold-ctrl"
                                }
                                onChange={(e) =>
                                  saveWhispoConfig({ shortcut: e.target.value })
                                }
                              >
                            ...
                            >
                              <Switch
                                checked={
                                  whispoConfigQuery.data.enableAudioCues ?? true
                                }
                                onCheckedChange={(checked) =>
                                  saveWhispoConfig({ enableAudioCues: checked })
                                }
                              />
                              <span
                                style={{
                          ...
                          <div className={styles.ExpandableContent}>
                            ...
                            >
                              ...
                              <select
                                className={styles.Select}
                                value={
                                  whispoConfigQuery.data.language || "en-US"
                                }
                                onChange={(e) =>
                                  saveWhispoConfig({ language: e.target.value })
                                }
                              >
                            ...
                            >
                              <Switch
                                checked={
                                  whispoConfigQuery.data.launchOnStartup ??
                                  false
                                }
                                onCheckedChange={(checked) =>
                                  saveWhispoConfig({ launchOnStartup: checked })
                                }
                              />
                              <span
                                style={{
                            ...
                            >
                              <Switch
                                checked={
                                  whispoConfigQuery.data.preserveClipboard ??
                                  true
                                }
                                onCheckedChange={(checked) =>
                                  saveWhispoConfig({
                            ...
                            {window.electron?.isMac && (
                              ...
                              >
                                <Switch
                                  checked={
                                    whispoConfigQuery.data.hideDockIcon ?? false
                                  }
                                  onCheckedChange={(checked) =>
                                    saveWhispoConfig({ hideDockIcon: checked })
                                  }
                                />
                                <span
                                  style={{
                      ...
                      >
                        ...
                        >
                          <input
                            ...
                            checked={
                              whispoConfigQuery.data.enhancementEnabled ?? false
                            }
                            onChange={(e) =>
                              saveWhispoConfig({
                          ...
                          <span
                            style={{
                              ...
                              right: 0,
                              bottom: 0,
                              backgroundColor: whispoConfigQuery.data
                                .enhancementEnabled
                                ? "var(--active)"
                                : "var(--secondary-bg)",
                              borderRadius: "22px",
                          ...
                          >
                            <span
                              style={{
                                ...
                                height: "16px",
                                width: "16px",
                                left: whispoConfigQuery.data.enhancementEnabled
                                  ? "21px"
                                  : "3px",
                                bottom: "3px",
                        ...
                        <>
                          ...
                          >
                            ...
                            <select
                              className={styles.Select}
                              value={
                                whispoConfigQuery.data.enhancementProvider ||
                                "openai"
                              }
                              onChange={(e) =>
                                saveWhispoConfig({
                          ...
                          {whispoConfigQuery.data.enhancementProvider ===
                            ...
                            >
                              ...
                              <select
                                className={styles.Select}
                                value={
                                  whispoConfigQuery.data.enhancementGroqModel ||
                            ...
                            >
                              ...
                              {openrouterModels.length === 0 ? (
                                ...
                                <select
                                  className={styles.Select}
                                  value={
                                    whispoConfigQuery.data.openrouterModel || ""
                                  }
                                  onChange={(e) =>
                                    saveWhispoConfig({
                          ...
                          <div className={styles.ExpandableSection}>
                            ...
                            {expandedSection === "prompts" && (
                              <div className={styles.ExpandableContent}>
                                ...
                                >
                                  {(whispoConfigQuery.data.customPrompts || [])
                                    .length === 0 ? (
                                    <div
                                      style={{
                                        fontSize: "11px",
